...
<?php
if ($_GET['msg'] != 'login' && ($_GET['msg'] != 'ProfileCompleted' && $_GET['msg'] != 'Updated')) {
    session_destroy();
    header('Location: login.php?msg=outIndex');
} else {
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $user[1] . " " . $user[2] ?></span>
                                <img class="img-profile rounded-circle" src="images/<?php echo $details[2] ?>">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <button onclick="viewProfile()" class="dropdown-item">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-secondary" type="button" data-dismiss="modal" onclick="logout()">Logout</button>
                </div>
